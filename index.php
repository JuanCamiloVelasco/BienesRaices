...
?>
    ...
    <section class="imagen-contacto">
        ...
        <p>Lena el formulario de contacto y un asesor se pondra en contacto contigo a la brevedad</p>
    ...
    <div class="contenedor seccion seccion-inferior">
        ...
        <section class="testimoniales">
            ...
            <div class="testimonial">
                <blockquote>
                    El personal se comporto de una excelente forma, muy buena atencio y la casa que me ofrecieron cumple con todas mis espectativas
                </blockquote>
                <p>- Juan Camilo Velasco</p>
            </div>
        </section>
    </div>
